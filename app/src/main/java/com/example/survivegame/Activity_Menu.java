...
public class Activity_Menu extends AppCompatActivity {
    ...
    private void findViews() {
        ...
        this.menu_EDT_err = (TextView) findViewById(R.id.menu_EDT_err);
    }
    ...
    private void startGame(String id, String data) {
        if(id.length() == 9) {
            menu_EDT_err.setVisibility(View.INVISIBLE);
            ...
            new Handler(Looper.getMainLooper()).post(new Runnable(){
                @Override
                public void run() {
                    menu_EDT_err.setVisibility(View.VISIBLE);
                }
            });
        }
    }
